...
public enum TileType {
	...
	public boolean compare(TileType tile, int angle1, int angle2) {
		...
		switch(diff) {
		case 0: return this.left.equals(tile.left)
				&&this.top.equals(tile.top)
				&&this.right.equals(tile.right)
				&&this.down.equals(tile.down);
		
		case 1: return this.left.equals(tile.down)
				&&this.top.equals(tile.left)
				&&this.right.equals(tile.top)
				&&this.down.equals(tile.right);
		
		case 2: return this.left.equals(tile.right)
				&&this.top.equals(tile.down)
				&&this.right.equals(tile.left)
				&&this.down.equals(tile.top);
		
		case 3: return this.left.equals(tile.top)
				&&this.top.equals(tile.right)
				&&this.right.equals(tile.down)
